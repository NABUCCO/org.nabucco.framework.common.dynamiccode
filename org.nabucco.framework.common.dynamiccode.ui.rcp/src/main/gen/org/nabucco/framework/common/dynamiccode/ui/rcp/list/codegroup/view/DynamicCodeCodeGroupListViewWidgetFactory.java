...
/**
 * DynamicCodeCodeGroupListViewWidgetFactory<p/>ListView for DynamicCodeCodeGroup<p/>
 *
 * @author Stefanie Feld, PRODYNA AG, 2010-03-16
 */
public class DynamicCodeCodeGroupListViewWidgetFactory extends WidgetFactory {

    /**
     * Constructs a new DynamicCodeCodeGroupListViewWidgetFactory instance.
     *
     * @param nabuccoFormToolKit the NabuccoFormToolkit.
     */
    public DynamicCodeCodeGroupListViewWidgetFactory(NabuccoFormToolkit nabuccoFormToolKit) {
