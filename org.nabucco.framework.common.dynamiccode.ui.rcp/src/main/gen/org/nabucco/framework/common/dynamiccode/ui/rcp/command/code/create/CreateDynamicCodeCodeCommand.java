...
public class CreateDynamicCodeCodeCommand implements NabuccoCommand {
    ...
    private CreateDynamicCodeCodeHandler createDynamicCodeCodeHandler = NabuccoInjector.getInstance(
            CreateDynamicCodeCodeCommand.class).inject(CreateDynamicCodeCodeHandler.class);
