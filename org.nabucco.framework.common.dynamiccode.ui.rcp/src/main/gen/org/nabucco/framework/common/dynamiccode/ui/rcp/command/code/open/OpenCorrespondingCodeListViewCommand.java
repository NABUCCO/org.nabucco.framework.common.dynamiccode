...
public class OpenCorrespondingCodeListViewCommand implements NabuccoCommand {
    ...
    private OpenDynamicCodeCodeListViewHandler openDynamicCodeCodeListViewHandler = NabuccoInjector.getInstance(
            OpenCorrespondingCodeListViewCommand.class).inject(OpenDynamicCodeCodeListViewHandler.class);
