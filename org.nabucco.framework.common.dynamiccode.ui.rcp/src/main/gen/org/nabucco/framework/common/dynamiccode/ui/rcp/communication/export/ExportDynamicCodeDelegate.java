 ...
 */
package org.nabucco.framework.common.dynamiccode.ui.rcp.communication.export;
...
public class ExportDynamicCodeDelegate extends ServiceDelegateSupport {
    ...
    public ExportRs export(EmptyServiceMessage message, ServiceSubContext... subContexts) throws ClientException {
        ...
        throw new ClientException("Cannot execute service operation: ExportDynamicCode.export");
    }
     ...
     * @throws ClientException
     */
    public DynamicCodeCodeGroupMsg exportRootGroup(EmptyServiceMessage message, ServiceSubContext... subContexts)
            throws ClientException {
        ServiceRequest<EmptyServiceMessage> request = new ServiceRequest<EmptyServiceMessage>(
                super.createServiceContext(subContexts));
        request.setRequestMessage(message);
        ...
        throw new ClientException("Cannot execute service operation: ExportDynamicCode.exportRootGroup");
    }
}
