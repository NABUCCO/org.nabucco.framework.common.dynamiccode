...
public class SaveDynamicCodeCodeGroupCommand implements NabuccoCommand {
    ...
    private SaveDynamicCodeCodeGroupHandler saveDynamicCodeCodeGroupHandler = NabuccoInjector.getInstance(
            SaveDynamicCodeCodeGroupCommand.class).inject(SaveDynamicCodeCodeGroupHandler.class);
