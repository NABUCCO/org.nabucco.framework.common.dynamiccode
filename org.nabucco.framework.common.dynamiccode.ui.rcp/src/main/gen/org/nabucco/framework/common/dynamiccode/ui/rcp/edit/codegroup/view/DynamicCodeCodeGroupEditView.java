...
/**
 * DynamicCodeCodeGroupEditView<p/>@Edit view for datatype DynamicCodeCodeGroup<p/>
 *
 * @author Stefanie Feld, PRODYNA AG, 2010-03-22
 */
public class DynamicCodeCodeGroupEditView extends EditView<DynamicCodeCodeGroupEditViewModel> {

    public static final String ID = "org.nabucco.framework.common.dynamiccode.ui.edit.codegroup.DynamicCodeCodeGroupEditView";
    ...
    /** Constructs a new DynamicCodeCodeGroupEditView instance. */
    public DynamicCodeCodeGroupEditView() {
        super();
    }
    ...
    protected void createFormControl(Form form) {
        ...
        model = new DynamicCodeCodeGroupEditViewModel();
