 ...
 */
public class CreateDynamicCodeCodeHandlerImpl extends
        NabuccoAbstractAddDatatypeHandlerImpl<DynamicCodeCodeEditViewModel> implements
        CreateDynamicCodeCodeHandler {
    ...
    private DynamicCodeCode createNewDynamicCodeCode() {
        ...
        try {
            ProduceDynamicCodeDelegate produceAuthorization = DynamicCodeComponentServiceDelegateFactory
                    .getInstance().getProduceDynamicCode();
            DynamicCodeCodeMsg response = produceAuthorization
                    .produceDynamicCodeCode(new EmptyServiceMessage());
