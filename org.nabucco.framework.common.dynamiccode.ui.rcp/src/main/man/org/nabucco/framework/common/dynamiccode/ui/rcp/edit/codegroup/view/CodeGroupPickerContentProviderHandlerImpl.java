...
public class CodeGroupPickerContentProviderHandlerImpl implements
    ...
    public Map<String, DynamicCodeCodeGroup[]> loadAllDynamicCodeCodeGroup(
            DynamicCodeCodeGroupEditViewModel viewModel) {
     ...
     */
    private boolean needsRefresh(DynamicCodeCodeGroupEditViewModel viewModel) {
        if (viewModel == null) {
            return false;
        }
        ...
        boolean result = currentCodeGroup != viewModel.getCodeGroup();
        currentCodeGroup = viewModel.getCodeGroup();

        return result;
    }

    private void loadCodeGroups(DynamicCodeCodeGroupEditViewModel viewModel) {
        ...
        try {
            ...
            for (DynamicCodeCodeGroup codeGroup : codeGroups.getDynamicCodeCodeGroupList()) {
                if (!codeGroup.equals(viewModel.getCodeGroup())) {
