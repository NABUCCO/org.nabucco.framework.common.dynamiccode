...
/**
 * DynamicCodeImageRegistry
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
@Deprecated
public enum DynamicCodeImageRegistry {

    ICON_CODE("images/code.png", "/images/code.png"),

    ICON_CODEGROUP("images/codedictionary.png", "/images/codedictionary.png");
    ...
    private DynamicCodeImageRegistry(String id, String resourcePath) {
        this.id = id;
