...
public class DynamicCodeCodeGroupMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(DynamicCodeCodeGroupMsg.getPropertyDescriptor(CODEGROUP),
                this.getCodeGroup()));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(DynamicCodeCodeGroupMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(DynamicCodeCodeGroupMsg.class).getAllProperties();
    }
}
