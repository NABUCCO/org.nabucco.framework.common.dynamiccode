...
public class DynamicCodeCodeListMsg extends ServiceMessageSupport implements ServiceMessage {
    ...
    protected static NabuccoPropertyContainer createPropertyContainer() {
        ...
        propertyMap.put(CODELIST, PropertyDescriptorSupport.createCollection(CODELIST, DynamicCodeCode.class, 0,
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(DynamicCodeCodeListMsg.getPropertyDescriptor(CODELIST), this.codeList));
        return properties;
    }
    ...
    public boolean setProperty(NabuccoProperty property) {
        ...
        if ((property.getName().equals(CODELIST) && (property.getType() == DynamicCodeCode.class))) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(DynamicCodeCodeListMsg.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(DynamicCodeCodeListMsg.class).getAllProperties();
    }
}
