...
public class DynamicCodeCodeResolveRs extends ServiceMessageSupport implements ServiceMessage {
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(DynamicCodeCodeResolveRs.getPropertyDescriptor(CODE), this.getCode()));
        properties.add(super.createProperty(DynamicCodeCodeResolveRs.getPropertyDescriptor(PARENTGROUP),
                this.getParentGroup()));
        return properties;
    }
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(DynamicCodeCodeResolveRs.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(DynamicCodeCodeResolveRs.class).getAllProperties();
    }
}
