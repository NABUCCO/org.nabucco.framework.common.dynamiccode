...
/**
 * ImportDynamicCodeServiceHandler<p/>Service to import dynamic code<p/>
 *
 * @version 1.0
 * @author Silas Schwarz, PRODYNA AG, 2011-02-26
 */
public abstract class ImportDynamicCodeServiceHandler extends PersistenceServiceHandlerSupport implements
        ServiceHandler, PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.common.dynamiccode.impl.service.importing.ImportDynamicCodeServiceHandler";

    /** Constructs a new ImportDynamicCodeServiceHandler instance. */
    public ImportDynamicCodeServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<ImportRs> invoke(ServiceRequest<ImportRq> rq) throws ImportException {
        ...
        try {
            ...
            msg = this.importDynamicCode(rq.getRequestMessage());
            if ((msg == null)) {
    ...
    /**
     * Missing description at method importDynamicCode.
     *
     * @param msg the ImportRq.
     * @return the ImportRs.
     * @throws ImportException
     */
    protected abstract ImportRs importDynamicCode(ImportRq msg) throws ImportException;
