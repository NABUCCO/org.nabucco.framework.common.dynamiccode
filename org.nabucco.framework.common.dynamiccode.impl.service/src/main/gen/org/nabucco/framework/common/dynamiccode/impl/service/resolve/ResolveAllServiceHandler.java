...
/**
 * ResolveAllServiceHandler<p/>Resolution Service for DynamicCode<p/>
 *
 * @version 1.0
 * @author Nicolas Moser, PRODYNA AG, 2010-06-06
 */
public abstract class ResolveAllServiceHandler extends PersistenceServiceHandlerSupport implements ServiceHandler,
        PersistenceServiceHandler {

    private static final long serialVersionUID = 1L;

    private static final String ID = "org.nabucco.framework.common.dynamiccode.impl.service.resolve.ResolveAllServiceHandler";

    /** Constructs a new ResolveAllServiceHandler instance. */
    public ResolveAllServiceHandler() {
        super();
    }
    ...
    protected ServiceResponse<DynamicCodeCodeGroupMsg> invoke(ServiceRequest<EmptyServiceMessage> rq)
        ...
        try {
            ...
            msg = this.resolveAll(rq.getRequestMessage());
            if ((msg == null)) {
     ...
     * @throws ResolveException
     */
    protected abstract DynamicCodeCodeGroupMsg resolveAll(EmptyServiceMessage msg) throws ResolveException;
