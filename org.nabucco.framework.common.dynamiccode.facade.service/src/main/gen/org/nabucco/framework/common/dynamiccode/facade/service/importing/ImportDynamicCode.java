 ...
 */
package org.nabucco.framework.common.dynamiccode.facade.service.importing;
...
/**
 * ImportDynamicCode<p/>Service to import dynamic code<p/>
 *
 * @version 1.0
 * @author Silas Schwarz, PRODYNA AG, 2011-02-26
 */
public interface ImportDynamicCode extends Service {
     ...
     */
    ServiceResponse<ImportRs> importDynamicCode(ServiceRequest<ImportRq> rq) throws ImportException;
}
