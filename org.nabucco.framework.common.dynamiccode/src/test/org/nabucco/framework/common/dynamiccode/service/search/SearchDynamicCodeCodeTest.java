...
public class SearchDynamicCodeCodeTest extends RuntimeTestSupport {
    ...
    public void testCodeSearch() throws Exception {
        ...
        DynamicCodeCode code = DynamicCodeTestUtility.createCode(this.component, DynamicCodeTestUtility.dummyCode());
        ...
        ServiceResponse<DynamicCodeCodeListMsg> rs = this.component.getSearchDynamicCode().searchDynamicCodeCode(rq);
